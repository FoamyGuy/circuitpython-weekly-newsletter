---
layout: post
title: "CircuitPython 9.2.4 Out, Machine Learning on Raspberry Pi, and Much More!"
...
Welcome to the latest Python on Microcontrollers newsletter! A new version of CircuitPython is available with some fixes and features. The main focus is a trio of articles on machine learning (often called AI). Rather than just parrot hype, I quote three articles: two on running models on Raspberry Pi hardware and another on ethics and data handling. I believe they will have broad interest to readers. As always, there is a bevy of other content including projects to catch your interest. Happy February. - *Anne Barela, Editor*
...
John Park’s CircuitPython Parsec this week is on LED Matrix Shifting - [Adafruit Blog](https://blog.adafruit.com/2025/01/31/john-parks-circuitpython-parsec-led-matrix-shifting-adafruit-circuitpython/) and [YouTube](https://youtu.be/sbnPeJDpwyM).
...
[![Old phone reads poetry to you using a Raspberry Pi Zero](../assets/20250203/20250203phone.jpg)](https://www.youtube.com/watch?v=WpBV4LH22vA)

Théo Z. V. Champion modifies an old phone to read poetry using a Raspberry Pi Zero - [YouTube](https://www.youtube.com/watch?v=WpBV4LH22vA). Via [Tom's Hardware](https://www.tomshardware.com/raspberry-pi/this-old-phone-reads-poetry-to-you-using-a-raspberry-pi-zero).
...
- [ESP32-S3 ETH Development Board](https://circuitpython.org/board/waveshare_esp32_s3_matrix/)
- [ESP32-P4 Stamp XL](https://circuitpython.org/board/solderparty_esp32p4_stamp_xl/)
- [ESP32-S3-Matrix Development Board](https://circuitpython.org/board/waveshare_esp32_s3_eth/)
- [M5StickC PLUS ESP32-PICO Mini IoT](https://circuitpython.org/board/m5stack_stick_c_plus2/)
- [ESP32-C6 1.47inch Display Development Board](https://circuitpython.org/board/waveshare_esp32_c6_lcd_1_47/)
- [MAX32690 Evaluation Kit](https://circuitpython.org/board/max32690evkit/)
- [AD-APARD32690-SL](https://circuitpython.org/board/apard32690/)
...
The current number of CircuitPython libraries is **502**!

**New Libraries**

Here's this week's new CircuitPython libraries:

  * [bablokb/cp-buzzer-music](https://github.com/bablokb/cp-buzzer-music)
  * [noelanderson/CircuitPython_FS3000](https://github.com/noelanderson/CircuitPython_FS3000)
...
PyCascades is a regional PyCon in the Pacific Northwest, celebrating the west coast Python developer and user community. The organizing team includes members of the Vancouver, Seattle, and Portland Python user groups. February 8-9, Portland, Oregon US - [PyCascades 2025](https://2025.pycascades.com/).
...
[20250131](https://github.com/adafruit/Adafruit_CircuitPython_Bundle/releases/latest) is the latest Adafruit CircuitPython library bundle.
...
[4,186 Stars](https://github.com/adafruit/circuitpython/stargazers) Like CircuitPython? [Star it on GitHub!](https://github.com/adafruit/circuitpython)
