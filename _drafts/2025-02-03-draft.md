...
Software Heritage founded in 2016 to collect and preserve all publicly available source code. After the ChatGPT explosion, it became clear rather quickly that Software Heritage held the largest dataset for training AI models on code in the world. Another IEEE Spectrum article  delves into ethical coding of AIs, data cleaning, opt-out, personal information in open code, license checks, and more - [IEEE Spectrum](https://spectrum.ieee.org/coding-ai).
