...
A baby logger for tracking various vital functions during the first few months after birth using Python on a Raspberry Pi Zero W - [https://hackaday.io/project/202150-baby-logger](https://hackaday.io/project/202150-baby-logger) and [GitHub](https://github.com/TriceratopsLabs/Baby-logger).
