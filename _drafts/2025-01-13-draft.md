...
An MQTT message display with word wrapping on a Pimoroni Presto display - [GitHub](https://github.com/digitalurban/Presto_MQTT_Display). Via [X](https://bsky.app/profile/digitalurban.bsky.social/post/3ldxvai4jsc2i).
