...
Tom's Hardware: The Pi Cast has Raspberry Pi CTO Gordon Hollingworth on the show to talk about software engineering for the Raspberry Pi - [YouTube](https://www.youtube.com/watch?v=UxO4qiw9kIw).
...
Hackaday provides some additional details on the Tanmatsu (Japanese for “Terminal”), powered by the new Espressif ESP32-P4 application processor. It's expected to run MicroPython and native applications - [site](https://hackaday.com/2025/02/04/a-closer-look-at-the-tanmatsu/).
