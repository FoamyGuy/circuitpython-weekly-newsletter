---
layout: post
title: "MicroPython Focus, Fruit Jam, VSC Debugging and More!"
...
Welcome to the latest Python on Microcontrollers newsletter! This week's issue leans into MicroPython with some interesting content. The announced Adafruit RP2350B single board computer is something your editor has been waiting for to emulate classic gear. This has been a busy week, see all that has been happening with the content in this issue.  - *Anne Barela, Editor*
...
[![PioMatter Library For Raspberry Pi 5](../assets/20250210/20250210hub.jpg)](https://www.hackster.io/news/adafruit-s-piomatter-library-brings-hub75-rgb-led-matrix-support-to-the-raspberry-pi-5-s-rp1-chip-70bfb3c3bdd8)
...
[![Python 3.13.2 and 3.12.9 now available](../assets/20250210/20250210psf.jpg)](https://pythoninsider.blogspot.com/)

Python 3.13.2 and 3.12.9 now available - [Python Insider Blog](https://pythoninsider.blogspot.com/).
...
[Last Friday](https://youtube.com/live/DEWPN7yhn5U), Scott streamed Zephyr WiFi in CircuitPython, take 3.
...
[![Interstate 75W](../assets/20250210/20250210w75.gif)](https://bsky.app/profile/gadgetoid.com)
...
7 exciting projects for a 16GB Raspberry Pi 5 - [ArtFormWorld](https://artformworld.com/2025/02/07/7-exciting-projects-for-your-16gb-raspberry-pi-5/).
...
A build of bastardkb's Skeletyl split ergonomic keyboard with an RP2040 and CircuitPython - [hackster.io](https://www.hackster.io/hendra/dactyl-skeletyl-f7da22).
...
[![How to build Ollama to run LLMs on RISC-V Linux](../assets/20250210/20250210lama.jpg)](https://www.jeffgeerling.com/blog/2025/how-build-ollama-run-llms-on-risc-v-linux)

How to build Ollama to run LLMs on RISC-V Linux - [Jeff Geerling](https://www.jeffgeerling.com/blog/2025/how-build-ollama-run-llms-on-risc-v-linux).

[![How do PIR (passive infrared) sensors work](../assets/20250210/20250210pir.jpg)](https://www.circuitbasics.com/detecting-motion/)

How do PIR (passive infrared) sensors work and how to connect them to a Raspberry Pi with Python - [Circuit Basics](https://www.circuitbasics.com/detecting-motion/).
...
[![5 Python libraries to extend Excel’s capabilities](../assets/20250210/20250210excel.jpg)](https://www.xda-developers.com/python-libraries-extend-excels-capabilities/)

5 Python libraries to extend Excel’s capabilities - [XDA](https://www.xda-developers.com/python-libraries-extend-excels-capabilities/).
...
[20250206](https://github.com/adafruit/Adafruit_CircuitPython_Bundle/releases/latest) is the latest Adafruit CircuitPython library bundle.
...
[3.13.2](https://www.python.org/downloads/) is the latest Python release. The latest pre-release version is [3.14.0a4](https://www.python.org/download/pre-releases/).

[4,191 Stars](https://github.com/adafruit/circuitpython/stargazers) Like CircuitPython? [Star it on GitHub!](https://github.com/adafruit/circuitpython)
...
[![38,742 THANKS](../assets/20250210/38kdiscord.jpg)](https://adafru.it/discord)

[![Adafruit Discord](https://discordapp.com/api/guilds/327254708534116352/embed.png?style=banner3)](https://discord.gg/adafruit)

The Adafruit Discord community, where we do all our CircuitPython development in the open, reached over 38,742 humans - thank you! Adafruit believes Discord offers a unique way for Python on hardware folks to connect. Join today at [https://adafru.it/discord](https://adafru.it/discord).
