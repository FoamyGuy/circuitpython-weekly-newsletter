...
CuPy is an open-source array library for GPU-accelerated computing with Python. CuPy utilizes nVidia CUDA Toolkit libraries to make full use of the GPU architecture - [cupy.dev](https://cupy.dev/).
